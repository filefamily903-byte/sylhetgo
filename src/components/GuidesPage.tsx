...
export default function GuidesPage() {
  ...
  // 🔥 ফিক্সড ফিল্টার লজিক: অ্যাডমিন দ্বারা এপ্রুভড (Verified Local Guide, SREDA Certified, Eco Guide) গাইডদেরই শুধু দেখাবে।
  // নতুন কেউ ফর্ম সাবমিট করলে তার ব্যাজ "Unverified" থাকবে, তাই এপ্রুভ হওয়ার আগে মেইন পেজে শো করবে না!
  const filteredGuides = guides.filter(guide => {
    const isVerified = 
      guide.badge === "Verified Local Guide" || 
      guide.badge === "SREDA Certified" || 
      guide.badge === "Eco Guide";
